...
function selfie_setup() {
	...
	add_image_size( 'selfie-featured-image', 640, 9999 );
...
function selfie_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'selfie_content_width', 640 );
}
...
function selfie_scripts() {
	...
	wp_enqueue_script( 'selfie-navigation', get_template_directory_uri() . '/assets/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'selfie-skip-link-focus-fix', get_template_directory_uri() . '/assets/js/skip-link-focus-fix.js', array(), '20151215', true );
