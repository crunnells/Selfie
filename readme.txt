...
* Fixed spacing in post comments and added separators between comments
* Fixed an issue with the Content Option separator JS not firing during Infinite Scroll

= 1.0.7 - 05-16-2017 =
* Fixed an escape issue with the search form
* Fixed an issue with the Author (JetPack) widget
* Removed some unnecessary RTL styles
...
= 1.0.3 - 05-10-2017 =
* Changed comment styling to better match the theme
* Added support for Jetpack Social Menu SVG icons
* Fixed separator display in entry-meta

= 1.0.2 - 05-08-2017 =
* Fixed Custom Logo settings to allow flex size without breaking the layout
* Fixed a minor layout issue on tablet sized screens
